...
$cdt=$mysqli->real_escape_string($_POST['cdt2']);
...
$sql="INSERT INTO measure1(userID, cdt,
   q1, q2, q3, q4, q5, open)
   VALUES('$userID', '$cdt',
   '$q1', '$q2', '$q3', '$q4','$q5','$open')";
   ...
   if ($insert){
     //echo "<a href='measures2.php'>Next page</a>";
   }
...
<a class="next" href='measures2.html'><br>NEXT</br></a>
</body>
</html>
