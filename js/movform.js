...
function showTab(n) {
  ...
  //var t=document.getElementById("title"+n);
  ...
  element.innerHTML = "<h3>Based on the movie details, how likely will you watch this movie?</h3>";
  //document.getElementById("descr").innerHTML="<h3>This is the rating distribution for the recommend movie:";
